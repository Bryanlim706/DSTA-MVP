...
# Overrides primary for backend_api_only — the main requirement-verification tool for that stack.
# Python frameworks map to "Pytest API tests" so endpoint tests are primary, not unit tests.
# JS frameworks map to "Jest/Supertest" so HTTP integration tests are primary, not plain Jest.
