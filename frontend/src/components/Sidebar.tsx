...
const STEPS: { id: number; label: string; sub?: boolean }[] = [
  ...
  { id: 1,   label: 'Repo Parser' },
  { id: 2,   label: 'Stated Requirements' },
  { id: 2.5, label: 'Obvious Requirements', sub: true },
  { id: 3,   label: 'Implied Functions' },
  { id: 3.5, label: 'Requirement Review', sub: true },
  { id: 4,   label: 'UI/API Inventory' },
  { id: 5,   label: 'Mapper' },
  { id: 6,   label: 'Completeness Score' },
  { id: 7,   label: 'Test Generator' },
  { id: 8,   label: 'Oracle Validator' },
  { id: 9,   label: 'Test Sandbox' },
  { id: 10,  label: 'Evidence Collector' },
  { id: 11,  label: 'Correctness Score' },
  { id: 12,  label: 'Appropriateness' },
  { id: 13,  label: 'Evidence Pack' },
  { id: 14,  label: 'LLM Evaluator' },
